...
public class Componente extends UINamingContainer {
    ...
    public void setDataTable(UIComponent dataTable) {
    ...
    /**
     * Decide si se pinta el enlace o no
     * @param orden campo por el que ordenar
     * @param ascendente Si es ascendente o descendente
     * @return 
     */
    ...
    public String borrar(){
        ...
        FacesContext fc = FacesContext.getCurrentInstance();
        fc.addMessage(dataTable.getClientId(),new FacesMessage("borrado",mensaje));
        return "";
    }
    public String editar(){
        ...
        FacesContext fc = FacesContext.getCurrentInstance();
        fc.addMessage(dataTable.getClientId(),new FacesMessage("edicion",mensaje));
        return "";
    }
    public String insertar(){
        ...
        FacesContext fc = FacesContext.getCurrentInstance();
        fc.addMessage(dataTable.getClientId(),new FacesMessage("insercion",mensaje));
        return "";
    }
